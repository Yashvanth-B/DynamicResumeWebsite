...
function dark() {
  darkmode.value = "Normal Mode";
  side.style.color = "white";
  side.style.backgroundImage =
    " linear-gradient(to right,rgba(0, 0, 0),rgb(0, 0, 0)) ";
...
function redon() {
  side.style.backgroundImage =
    "linear-gradient(to right,rgb(24, 1, 97),rgb(79, 23, 135),rgb(235, 54, 120),rgb(251, 119, 60))";
  mainscreen.style.backgroundImage =
    "linear-gradient(to right,rgb(24, 1, 97),rgb(79, 23, 135),rgb(235, 54, 120),rgb(251, 119, 60))";
}
function mixedon() {
  side.style.backgroundImage =
    "linear-gradient(to right,rgb(0, 224, 172),rgb(13, 78, 62),rgb(67, 81, 75)) ";
  mainscreen.style.backgroundImage =
    "linear-gradient(to right,rgb(0, 224, 172),rgb(13, 78, 62),rgb(67, 81, 75)) ";
}
function blueon() {
  side.style.backgroundImage =
    "linear-gradient(to right,rgb(98, 35, 154),rgb(77, 77, 77),rgb(69, 53, 85)) ";
  mainscreen.style.backgroundImage =
    "linear-gradient(to right,rgb(98, 35, 154),rgb(77, 77, 77),rgb(69, 53, 85))";
}
function offcc() {
